      ...
      <header className="absolute inset-x-0 top-0 z-50 flex justify-center">
        ...
        >
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {navigation.map((item) => (
              <a key={item.name} href={item.href} className="text-1xl font-semibold leading-6 text-gray-900 dark:text-white">
                {item.name}
              </a>
            ))}
          </div>
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            ...
            <a href="#contact" class="hidden lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo dark:border-white/50">Contact
